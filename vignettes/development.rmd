...
glimpse(mydata)
jurkats <- mydata %>%
  filter(Populations== "Barcoded") %>%
  select(-Individuals, -Sample.Type, -Populations, -Timepoints, -Doses, -Conditions) %>%
  select(-`PE-A`, -`Alexa Fluor 647-A`, -`Alexa Fluor 488-A`, 
         -`FSC-H`, -`FSC-W`, -`SSC-H`, -`SSC-W`, -`Alexa Fluor 700-A`)
library(devtools)
